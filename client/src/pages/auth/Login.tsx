...
const Login: React.FC = () => {
  ...
  const groups =
    suGender === "female"
      ...
      : suGender === "male"
        ? MALE_GROUPS
        : suGender === "other"
          ? [{ label: "Choose your avatar", avatars: OTHER_AVATARS }]
          : [];
  ...
  const handleSignUp = async (e: React.MouseEvent) => {
    ...
    if (!suGender) {
      setSuError("Please select your gender.");
      return;
    }
    if (!suAvatar) {
      setSuError("Please pick an avatar.");
      return;
    }
      ...
      <div className={styles.card}>
        <div className={styles.cardTop}>
          ...
          <p className={styles.sub}>
            {tab === "signin"
              ? "Sign in to your Crumb & Bloom account"
              : "Join Crumb & Bloom to start ordering"}
          </p>
        </div>
            ...
            {suGender && (
              <div className={styles.field}>
                <label className={styles.label}>
                  Choose Your Avatar
                  {suAvatar && (
                    <span className={styles.avatarPreview}>{suAvatar}</span>
                  )}
                </label>
